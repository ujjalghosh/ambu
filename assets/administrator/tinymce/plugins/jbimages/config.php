...
$config['upload_path'] = $_SERVER['DOCUMENT_ROOT']."/"."/apostolictoolbox/uploads/editor_images" ;
$config['img_path'] = "http://".$_SERVER['SERVER_NAME'].'/apostolictoolbox/uploads/editor_images' ;
